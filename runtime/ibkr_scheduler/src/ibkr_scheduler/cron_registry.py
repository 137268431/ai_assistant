...
CRON_DEFINITIONS: list[dict[str, Any]] = [
    ...
    _definition(
        ...
        132.35,
        "*/5 4-20 * * 1-5",
        "工作日 America/New_York 04:00-20:59 每 5 分钟",
        ...
        beijing_cycle_label="北京时间 工作日 16:00-08:59（美东夏令时）/ 17:00-09:59（美东冬令时）每 5 分钟",
        et_cycle_label="美东时间 工作日 04:00-20:59 每 5 分钟",
