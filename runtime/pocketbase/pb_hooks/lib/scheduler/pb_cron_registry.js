const PB_CRON_DEFINITIONS = [
    ...
    {
        id: "order_detail_integrity_guard",
        config_key: "pb_cron_order_detail_integrity_guard_enabled",
        display_name: "订单明细自愈 Cron",
        config_display_name: "订单明细自愈",
        group_name: "PB Cron 调度",
        sort_order: 131.5,
        default_value: "TRUE",
        cron_expr: "*/10 * * * *",
        cycle_label: "每 10 分钟",
        beijing_cycle_label: "每 10 分钟",
        et_cycle_label: "每 10 分钟",
        window_label: "全天",
        function_summary: "巡检 orders 与 ibkr_order_details 的当前状态是否一致，缺失时自动回补当前状态明细。",
        scope_label: "按环境执行",
        note: "受 PB 调度总开关和本开关共同控制；默认静默补齐，不发送订单通知卡片。",
        hook_file: "order_scheduler.pb.js",
    },
    {
    ...
    {
        id: "ibkr_data_quality_open_sweep",
        config_key: "pb_cron_ibkr_data_quality_open_sweep_enabled",
        display_name: "开盘前全观察池 Sweep Cron",
        config_display_name: "开盘前全观察池 Sweep",
        group_name: "PB Cron 调度",
        sort_order: 136.2,
        default_value: "TRUE",
        cron_expr: "40 9 * * 1-5",
        cycle_label: "工作日 UTC 09:40",
        beijing_cycle_label: "北京时间 工作日 17:40",
        et_cycle_label: "美东时间 EDT 工作日 05:40",
        window_label: "开盘前",
        function_summary: "对全观察池执行一次 5m 内部一致性 sweep，并尝试安全修复可回补问题。",
        scope_label: "按环境执行",
        note: "受 PB 调度总开关、Compute 开关和本开关共同控制。",
        hook_file: "ibkr_system_monitor.pb.js",
    },
    {
        id: "ibkr_data_quality_close_sweep",
        config_key: "pb_cron_ibkr_data_quality_close_sweep_enabled",
        display_name: "收盘后全观察池 Sweep Cron",
        config_display_name: "收盘后全观察池 Sweep",
        group_name: "PB Cron 调度",
        sort_order: 136.3,
        default_value: "TRUE",
        cron_expr: "10 20 * * 1-5",
        cycle_label: "工作日 UTC 20:10",
        beijing_cycle_label: "北京时间 工作日次日 04:10",
        et_cycle_label: "美东时间 EDT 工作日 16:10",
        window_label: "收盘后",
        function_summary: "收盘后再次对全观察池执行 5m 内部一致性 sweep，沉淀最终 coverage。",
        scope_label: "按环境执行",
        note: "受 PB 调度总开关、Compute 开关和本开关共同控制。",
        hook_file: "ibkr_system_monitor.pb.js",
    },
    {
        id: "ibkr_data_quality_truth_audit",
        config_key: "pb_cron_ibkr_data_quality_truth_audit_enabled",
        display_name: "收盘后 IBKR 真值审计 Cron",
        config_display_name: "收盘后 IBKR 真值审计",
        group_name: "PB Cron 调度",
        sort_order: 136.4,
        default_value: "TRUE",
        cron_expr: "20 20 * * 1-5",
        cycle_label: "工作日 UTC 20:20",
        beijing_cycle_label: "北京时间 工作日次日 04:20",
        et_cycle_label: "美东时间 EDT 工作日 16:20",
        window_label: "收盘后",
        function_summary: "对全观察池执行一次 stored bars vs IBKR authoritative history 真值审计。",
        scope_label: "按环境执行",
        note: "受 PB 调度总开关、Compute 开关和本开关共同控制；仅沉淀审计结果，不静默改写库内 bars。",
        hook_file: "ibkr_system_monitor.pb.js",
    },
    {
        id: "ibkr_weekly_reauth_reminder",
        config_key: "pb_cron_ibkr_weekly_reauth_reminder_enabled",
        display_name: "周验证提醒 Cron",
        config_display_name: "周验证提醒",
        group_name: "PB Cron 调度",
        sort_order: 137,
        default_value: "TRUE",
        cron_expr: "0 5 * * 1",
        cycle_label: "每周一 UTC 05:00",
        beijing_cycle_label: "北京时间 每周一 13:00 发送周验证提醒卡片",
        et_cycle_label: "美东时间 夏令时 EDT 周一 01:00；冬令时 EST 周一 00:00",
        window_label: "北京时间 周一 13:00",
        function_summary: "每周发送一张周验证提醒卡片；只提醒，不自动触发 Gateway 登录。",
        scope_label: "按环境执行",
        note: "受 PB 调度总开关和本开关共同控制。",
        hook_file: "ibkr_system_monitor.pb.js",
    },
    {
        id: "ibkr_weekly_reauth_followup",
        config_key: "pb_cron_ibkr_weekly_reauth_followup_enabled",
        display_name: "周验证补提醒 Cron",
        config_display_name: "周验证补提醒",
        group_name: "PB Cron 调度",
        sort_order: 137.5,
        default_value: "TRUE",
        cron_expr: "30 7 * * 1",
        cycle_label: "每周一 UTC 07:30",
        beijing_cycle_label: "北京时间 每周一 15:30 补发周验证提醒卡片",
        et_cycle_label: "美东时间 夏令时 EDT 周一 03:30；冬令时 EST 周一 02:30",
        window_label: "北京时间 周一 15:30",
        function_summary: "若周验证仍停在待手动触发阶段，则补发一张飞书验证卡片提醒。",
        scope_label: "按环境执行",
        note: "受 PB 调度总开关和本开关共同控制。",
        hook_file: "ibkr_system_monitor.pb.js",
    },
    ...
    },
    {
        ...
        window_label: "全天",
        function_summary: "清理超过留存窗口的 ibkr_bars / ibkr_indicators / ibkr_signals / ibkr_reverse_signals / ibkr_targets / ibkr_bar_integrity / ibkr_bar_truth_audit 历史数据。",
        scope_label: "按环境执行",
