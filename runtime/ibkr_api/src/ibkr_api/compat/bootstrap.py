...
def build_compat_proxy_deps(
    *,
    ...
    direct_proxy_map: dict[tuple[str, str], tuple[str, str]] = {
        ...
        ("GET", "ibkr/backtest/runs"): (compute_base_url, "/backtest/runs"),
        ("GET", "ibkr/backtest/run"): (compute_base_url, "/backtest/run"),
        ("GET", "ibkr/backtest/batches"): (compute_base_url, "/backtest/batches"),
        ("GET", "ibkr/backtest/batch"): (compute_base_url, "/backtest/batch"),
