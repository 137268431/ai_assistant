...
def register_startup_routes(app, *, deps: dict[str, Any]) -> dict[str, Any]:
    pb = deps["pb"]
    ...
    def custom_ibkr_startup_progress() -> Response:
        ...
        next_state["steps"] = merge_startup_steps(next_state.get("steps"), payload.get("steps"), bool(next_state.get("trigger_login")))
        ...
        saved_state = normalize_startup_state((saved_record or {}).get("data") if isinstance(saved_record, dict) else next_state, environment)
    ...
    def custom_ibkr_startup_status() -> Response:
        ...
        raw_state = deps["as_dict"](payload.get("data"))
        state = {
            **raw_state,
            ...
            "steps": deps["as_dict"](raw_state.get("steps")),
            "fields": deps["as_dict"](raw_state.get("fields")),
        }
        return jsonify(
            {
                "ok": True,
