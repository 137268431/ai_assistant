...
def build_platform_route_deps(
    *,
    ...
    return {
        ...
        "fetch_backtest_health": lambda environment: globals_dict["_fetch_backtest_health"](environment),
        "fetch_backtest_status": lambda environment: globals_dict["_fetch_backtest_status"](environment),
