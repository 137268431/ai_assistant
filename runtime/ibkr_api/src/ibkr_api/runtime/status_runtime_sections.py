...
def build_auth_recovery_summary(auth_recovery_payload: Any, *, as_dict: AsDict) -> dict[str, Any]:
    ...
    return {
        ...
        "disconnect_reason_code": str(auth_recovery.get("disconnect_reason_code") or ""),
        "disconnect_reason_label": str(auth_recovery.get("disconnect_reason_label") or ""),
        "disconnect_reason_confidence": str(auth_recovery.get("disconnect_reason_confidence") or ""),
        "disconnect_reason_evidence": as_dict(auth_recovery.get("disconnect_reason_evidence")),
