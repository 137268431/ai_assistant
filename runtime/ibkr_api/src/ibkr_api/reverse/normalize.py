...
def normalize_reverse_record(
    ...
    *,
    ...
    return {
        ...
        "risk_update_type": to_text(first_non_empty(extra.get("risk_update_type"), "")),
        "risk_update_seq": to_int(first_non_empty(extra.get("risk_update_seq"), 0), 0),
        "execution_readiness": to_text(first_non_empty(extra.get("execution_readiness"), "")),
        "execution_blocked_reason": to_text(first_non_empty(extra.get("execution_blocked_reason"), "")),
        "execution_blocked_message": to_text(first_non_empty(extra.get("execution_blocked_message"), "")),
        "order_linkage_status": to_text(first_non_empty(extra.get("order_linkage_status"), "")),
        "gateway_request_blocked": bool(extra.get("gateway_request_blocked")),
