        ...
        for result in eligible:
            ...
            extra = {
                **(result.get("extra") or {}),
                ...
                "regular_volume": round(_safe_float(result.get("regular_volume")), 2),
                "today_volume": round(_safe_float(result.get("today_volume")), 2),
                "elapsed_rvol": round(_safe_float(result.get("elapsed_rvol")), 4),
