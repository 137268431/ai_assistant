    ...
    *,
    ...
    return {
        ...
        "quality_gates": {
            ...
            "indicator_snapshot_intervals": DEFAULT_INDICATOR_SNAPSHOT_INTERVALS,
            "rollup_intervals": DEFAULT_SCAN_ROLLUP_INTERVALS,
            "materialize_intervals": DEFAULT_SCAN_MATERIALIZE_INTERVALS,
        },
        "subscription_budget": {
