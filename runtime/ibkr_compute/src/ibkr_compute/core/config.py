...
class Config:
    DEFAULTS = {
        ...
        "storage_cleanup_profile": "balanced_50g",
        "storage_cleanup_backtest_recent_limit": "30",
        ...
        "ibkr_history_max_concurrency": "20",
        "ibkr_history_request_spacing": "0.02",
        ...
        "intraday_min_rvol_20": "0",
        "intraday_min_atr_pct": "0",
        "intraday_max_atr_pct": "0",
        "intraday_max_directional_day_change_pct": "0",
        "intraday_trend_mismatch_max_abs_day_change_pct": "0",
        "intraday_vwap_pullback_long_require_trend_walk": "false",
        ...
        "live_exit_policy_stop_update_enabled": "true",
