...
class Config:
    DEFAULTS = {
        ...
        "ibkr_warmup_indicator_intervals": "5m,15m,30m,1h",
        ...
        "ibkr_warmup_indicator_backfill_intervals": "15m,30m,1h",
        ...
        "ibkr_history_max_concurrency": "4",
        "ibkr_history_request_spacing": "0.20",
        "ibkr_history_interval_delay": "0.35",
