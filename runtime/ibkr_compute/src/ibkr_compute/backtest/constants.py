...
from ibkr_compute.order.order_lifecycle import (
    DEFAULT_CONSECUTIVE_STOP_LOSS_LIMIT as LIVE_DEFAULT_CONSECUTIVE_STOP_LOSS_LIMIT,
    DEFAULT_POSITION_LIMIT_MAX as LIVE_DEFAULT_POSITION_LIMIT_MAX,
)
...
__all__ = [
    ...
    "DEFAULT_PORTFOLIO_CONSECUTIVE_STOP_LOSS_LIMIT",
...
FEE_MODEL_VALUES = {"legacy_flat_per_share_v1", "ibkr_us_equity_fixed_v1", "ibkr_us_equity_tiered_v1", "calibrated_v1"}
...
DEFAULT_BACKTEST_BACKFILL_CONCURRENCY = 8
MAX_BACKTEST_BACKFILL_CONCURRENCY = 10
...
DEFAULT_MAX_STRATEGY_OPEN_POSITIONS = _env_int(
    "BACKTEST_MAX_STRATEGY_OPEN_POSITIONS",
    5,
    minimum=0,
    maximum=100,
)
DEFAULT_PORTFOLIO_CONSECUTIVE_STOP_LOSS_LIMIT = LIVE_DEFAULT_CONSECUTIVE_STOP_LOSS_LIMIT
...
DEFAULT_FIXED_SYMBOLS = _env_symbol_tuple("BACKTEST_FIXED_SYMBOLS", "BOXX,IBKR")
