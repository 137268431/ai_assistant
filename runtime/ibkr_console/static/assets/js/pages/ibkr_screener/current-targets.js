    ...
    function humanizeCurrentSignalReason(reason) {
      ...
      const map = {
        ...
        entry_guard_quote_capacity_full: '实时行情订阅额度已满',
        entry_guard_quote_subscribe_timeout: '实时行情订阅超时',
        entry_guard_quote_snapshot_timeout: '报价快照拉取超时',
        entry_guard_quote_conid_unavailable: '无法解析合约行情标识',
        entry_guard_stop_already_crossed: '下单前已穿过止损位',
        entry_guard_price_drift: '下单前价格漂移过大',
        account_snapshot_unavailable: '账户快照不可用，等待重试',
        buying_power_unavailable: '购买力不可用，等待重试',
        gateway_unavailable: 'Gateway 不可用，等待重试',
        session_unauthenticated: '会话未认证，等待重试',
