...
function getIbkrCronCardData(definition = {}, configMap = {}, environment = '') {
    ...
    return {
        ...
        primaryCycleLabel: definition.et_cycle_label || definition.cycle_label || '--',
