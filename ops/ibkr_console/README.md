...
- `check_console_static_sync.py` now validates that `runtime/ibkr_console/static` and `runtime/pocketbase/pb_public` stay intentionally decoupled; it no longer expects a mirrored tree.
