...
class PocketBaseCompatProxyTest(unittest.TestCase):
    ...
    def test_runtime_status_config_startup_routes_in_ibkr_actions_are_api_proxies(self):
        ...
        expectations = {
            ...
            'routerAdd("POST", "/api/custom/ibkr/2fa/takeover", (c) => {': 'proxyIbkrApiJson(c, "/api/custom/ibkr/2fa/takeover"',
            'routerAdd("POST", "/api/custom/ibkr/2fa/probe", (c) => {': 'proxyIbkrApiJson(c, "/api/custom/ibkr/2fa/probe"',
            'routerAdd("POST", "/api/custom/ibkr/2fa/panic-reset", (c) => {': 'proxyIbkrApiJson(c, "/api/custom/ibkr/2fa/panic-reset"',
