...
class UniverseRoutesTest(unittest.TestCase):
    ...
    def test_today_targets_builds_signal_workflow_payload(self):
        ...
        self.assertEqual(1, payload["summary"]["target_active_count"])
        self.assertEqual(1, payload["summary"]["execution_active_count"])
    ...
    def test_today_targets_demotes_active_after_terminal_latest_signal(self):
        ...
        self.assertEqual(0, payload["summary"]["execution_active_count"])
        row = payload["items"][0]
        ...
        self.assertFalse(row["execution_active"])
        self.assertEqual("latest_signal_terminal", row["execution_state_reason"])
