...
class TradingViewStrategyCorePineTest(unittest.TestCase):
    ...
    def test_flow_labels_default_to_compact_tooltips(self):
        ...
        self.assertIn('flowLabelText("候选 多·SD↓\\n等组件", lowerActivateDetailText)', source)
    ...
    def test_entry_logic_requires_window_and_two_of_three_direction_components(self):
        ...
        self.assertIn("bool upperBullContinuationNow = confirmed and upperWindowValid and bullTrendContinuationContext", source)
        ...
        self.assertIn("bool setupLongTrendUpper = upperWindowValid and (upperBullTouchFresh or upperBullContinuationFresh) and longTrendUpperDirectionComponents >= 2", source)
        ...
        self.assertIn("(upperBullTouchSeen or upperBullContinuationSeen) ? 30 : 0", source)
