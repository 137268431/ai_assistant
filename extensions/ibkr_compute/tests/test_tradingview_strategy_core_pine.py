...
class TradingViewStrategyCorePineTest(unittest.TestCase):
    ...
    def test_probe_entries_support_predictive_and_confirmed_2b_orders(self):
        ...
        self.assertIn('topNoDemandWatch = confirmed and topPullbackArmed and topFailureWatchActive and not topHighVolumeDropConfirmed and volumeRatio < distributionDropVolumeMult', source)
        ...
        self.assertIn('topImmediatePullbackShort = topPullbackArmedEvent and topRetestBand and close < open', source)
        ...
        self.assertIn('topConfirmEntryRaw = topConfirmedShort ? (topCloseLimitShort ? close + syminfo.mintick', source)
        self.assertIn('topConfirmEntry = topConfirmedShort ? scalpLimitEntry(-1, close, topBasis, topConfirmEntryRaw, atr, scalpLimitOffsetAtr) : na', source)
    ...
    def test_quick_ema_scalp_uses_ema_target_rsi_filter_and_small_stop(self):
        ...
        self.assertIn('bool scalpRsiShortOk = scalpRsiWasHigh and scalpRsiWeakening', source)
        self.assertIn('bool scalpRsiLongOk = scalpRsiWasLow and scalpRsiStrengthening', source)
        ...
        self.assertIn('topConfirmEntry = topConfirmedShort ? scalpLimitEntry(-1, close, topBasis', source)
        self.assertIn('bottomConfirmEntry = bottomConfirmedLong ? scalpLimitEntry(1, close, bottomBasis', source)
        ...
        self.assertIn('selectedEntryNearAnchorOnly = selectedDirection == 0 or (not na(selectedEntryAnchorDistanceAtr) and selectedEntryAnchorDistanceAtr <= scalpMaxEntryAwayAtr)', source)
