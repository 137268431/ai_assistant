...
class TradingViewStrategyCorePineTest(unittest.TestCase):
    ...
    def test_probe_entries_support_predictive_and_confirmed_2b_orders(self):
        ...
        self.assertIn('topHighVolumeDropConfirmed = confirmed and topPullbackArmed and recentTopFailureWatchWindow and lastTopFailureWatchVolumeProbe', source)
        self.assertIn('topNakedTouchEvent = confirmed and dayRangeClear', source)
        self.assertIn('topHighVolumeProbeWatch = confirmed and topPullbackArmed and recentTopFailureWatchWindow', source)
        self.assertIn('topNoDemandWatch = confirmed and topPullbackArmed and recentTopFailureWatchWindow and not topHighVolumeDropConfirmed and volumeRatio < distributionDropVolumeMult', source)
        self.assertIn('topNoDemandBreakConfirmed = confirmed and topPullbackArmed and recentTopNoDemandWindow and topNoDemandStreak >= 2', source)
        ...
        self.assertIn('bottomNoSupplyWatch = confirmed and bottomPullbackArmed and recentBottomFailureWatchWindow and not bottomHighVolumeRiseConfirmed and volumeRatio < distributionDropVolumeMult', source)
        self.assertIn('bottomNoSupplyBreakConfirmed = confirmed and bottomPullbackArmed and recentBottomNoSupplyWindow and bottomNoSupplyStreak >= 2', source)
        ...
        self.assertIn('topConfirmedShort = topSweepFailed or upperExhaustionConfirmedShort or topWeakNewHighConfirmed or topDistributionDropConfirmed or topVolumeClimaxFailedBreakConfirmed or topHighVolumeDropConfirmed or topNoDemandBreakConfirmed', source)
        self.assertIn('topConfirmVolumeOk = topSweepFailed or topHighVolumeDropConfirmed or topNoDemandBreakConfirmed or topHighVolumeFailedBreak or upperExhaustionConfirmedShort or topWeakNewHighConfirmed or topDistributionDropConfirmed or topVolumeClimaxFailedBreakConfirmed', source)
        self.assertIn('topFailureWatchStop = math.max(nz(lastTopFailureWatchHigh, high), high) + invalidationBuffer', source)
        self.assertIn('topNoDemandBreakConfirmed ? topNoDemandStop', source)
        self.assertIn('topHighVolumeDropConfirmed ? topFailureWatchStop', source)
        ...
        self.assertIn('topConfirmContext = topConfirmedShort and (topCounterTrendAllowed or upperExhaustionConfirmedShort or topWeakNewHighConfirmed or topDistributionDropConfirmed or topVolumeClimaxFailedBreakConfirmed or topHighVolumeDropConfirmed or topNoDemandBreakConfirmed) and topSignalGapOk and topConfirmVolumeOk', source)
        ...
        self.assertIn('bottomFailureWatchStop = math.min(nz(lastBottomFailureWatchLow, low), low) - invalidationBuffer', source)
