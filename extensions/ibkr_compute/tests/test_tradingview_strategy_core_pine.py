...
class TradingViewStrategyCorePineTest(unittest.TestCase):
    ...
    def test_probe_entries_support_predictive_and_confirmed_2b_orders(self):
        ...
        self.assertIn('topProbePattern := topVolumeClimaxFailedBreakConfirmed ? "volume_climax_failed_break_short" : topHighVolumeDropConfirmed ? "naked_high_volume_reversal_short" : topImmediateReversalShort ? "naked_high_immediate_reversal_short"', source)
    ...
    def test_quick_ema_scalp_uses_ema_target_rsi_filter_and_small_stop(self):
        ...
        self.assertIn('selectedPlanValid = selectedDirection != 0 and selectedStructureClear and selectedEntryNearAnchor and selectedRsiPassed', source)
