...
class TradingViewStrategyCorePineTest(unittest.TestCase):
    ...
    def test_quick_ema_scalp_uses_ema_target_rsi_filter_and_small_stop(self):
        ...
        self.assertIn('selectedEntryNearAnchorOnly = selectedDirection == 0 or selectedProbeStrictTouchOk or (not na(selectedEntryAnchorDistanceAtr) and selectedEntryAnchorDistanceAtr <= scalpMaxEntryAwayAtr)', source)
        self.assertNotIn('selectedEntryNearAnchorOnly = selectedDirection == 0 or selectedProbeStrictTouchOk or selectedFailureRetestLimit', source)
