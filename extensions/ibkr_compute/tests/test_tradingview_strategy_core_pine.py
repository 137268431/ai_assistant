...
class TradingViewStrategyCorePineTest(unittest.TestCase):
    ...
    def test_display_explains_event_flow_and_four_plan_lines(self):
        ...
        self.assertIn('labelYForSide(labelAboveForDirection(direction), laneOffset)', display)
        self.assertIn('labelStyleForSide(labelAboveForDirection(direction))', display)
        self.assertIn('label.new(bar_index, flowY(selectedDirection, 1.5)', display)
        self.assertIn('label.new(bar_index, profitY(shadowDirection, 1.4)', display)
        self.assertIn('style=profitStyle(shadowDirection)', display)
