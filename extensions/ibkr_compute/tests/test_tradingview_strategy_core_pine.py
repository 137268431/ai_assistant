...
class TradingViewStrategyCorePineTest(unittest.TestCase):
    ...
    def test_pending_lifecycle_replaces_or_cancels_unfilled_predictions(self):
        ...
        self.assertIn('pendingOppositeSelected = pendingEntry and selectedDirection != 0 and selectedDirection != activeDirection and selectedStructureClear and selectedEntryNearAnchor and selectedRsiPassed', source)
    ...
    def test_quick_ema_scalp_uses_ema_target_rsi_filter_and_small_stop(self):
        ...
        self.assertIn('selectedPlanQualityOk = selectedStructureClear and selectedEntryNearAnchor and selectedRsiPassed', source)
    ...
    def test_display_explains_event_flow_and_four_plan_lines(self):
        ...
        self.assertIn('eventMarkerSize() =>', display)
        ...
        for line in display.splitlines():
            if "label.new(" in line:
                ...
                self.assertTrue("size=flowLabelSize()" in line or "size=eventMarkerSize()" in line)
        ...
        self.assertNotIn('ENTRY_WINDOW_MODEL + " / 09:10-15:30"', display)
        ...
        self.assertIn('eventMarker(selectedDirection, "blocked"', display)
