...
class TradingViewStrategyCorePineTest(unittest.TestCase):
    ...
    def test_signal_diagnostics_draw_filtered_candidates_without_alerts(self):
        ...
        self.assertIn("if flowLabelsVisible and showSignalDiagnostics and not pendingDisplayWaiting and blockedNow and blockedVisualKey != lastBlockVisualKey", source)
    ...
    def test_display_pending_entry_lifecycle_is_visual_only(self):
        ...
        self.assertIn('string pendingCancelDetailText = "撤销挂单\\n"', display)
        self.assertIn('string pendingCancelCompactText = "撤销挂单 " + pendingDirectionText', display)
        ...
        self.assertIn('currentPlanLineForwardBars = input.int(3, "Current plan line forward bars", minval=1, maxval=20, group="08 Display")', display)
        self.assertIn('showHistoricalPlanLines = input.bool(true, "Show historical Core plan lines", group="08 Display")', display)
        self.assertIn('historicalPlanLineForwardBars = input.int(8, "Historical plan line forward bars", minval=1, maxval=50, group="08 Display")', display)
        self.assertIn('maxHistoricalPlanLineSets = input.int(120, "Max historical plan line sets", minval=1, maxval=120, group="08 Display")', display)
        ...
        self.assertIn("int historicalEndBar = bar_index + historicalPlanLineForwardBars", display)
        ...
        self.assertIn("int planLineEndBar = bar_index + currentPlanLineForwardBars", display)
