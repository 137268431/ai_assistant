...
```bash
python3 extensions/pocketbase/scripts/schema/collection_usage_audit.py
```
...
```bash
python3 extensions/pocketbase/scripts/schema/collection_usage_audit.py reverse_signals
python3 extensions/pocketbase/scripts/schema/collection_usage_audit.py order_details
```
