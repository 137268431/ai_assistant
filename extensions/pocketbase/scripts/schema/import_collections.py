...
Examples:
  python3 extensions/pocketbase/scripts/schema/import_collections.py \
    extensions/pocketbase/schema/pb_table/schema_ibkr_backtest_reverse_signals.json \
...
SCHEMA_ROOT = POCKETBASE_ROOT / "schema" / "pb_table"
