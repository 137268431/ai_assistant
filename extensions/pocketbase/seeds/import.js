...
const configData = [
  ...
  cfg('exit_policy_profile', 'fixed_atr_rr', 'fixed_atr_rr', '退出策略 Profile', '信号与反转', 222.25, 'fixed_atr_rr=固定 ATR/RR 初始 bracket + ATR 收紧；signal_mode_adaptive_v1=按信号模式路由不同 TP/SL 策略'),
