...
const configData = [
  ...
  cfg('ibkr_buying_power_guard_paper_source', 'config', 'config', 'Paper购买力口径', '交易风控', 402.11, 'paper 自动开仓使用配置模型，不直接使用 paper 账户大额 BuyingPower'),
  cfg('ibkr_paper_risk_buying_power_usd', '194388.61', '194388.61', 'Paper风控购买力', '交易风控', 402.12, 'paper 模式用于模拟真实账户的可用日内 BuyingPower；随真实账户变化手动/自动更新该配置'),
  cfg('ibkr_paper_risk_net_liquidation_usd', '61398', '61398', 'Paper风控净值', '交易风控', 402.13, 'paper 模式阈值百分比计算使用的真实账户净值模型'),
  cfg('ibkr_paper_risk_default_entry_exposure_usd', '5000', '5000', 'Paper默认单笔占用', '交易风控', 402.14, 'paper 模式估算剩余可开仓数量和缺价格挂单占用时使用'),
