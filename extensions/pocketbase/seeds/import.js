...
const configData = [
  ...
  cfg('pb_cron_ibkr_early_expansion_topup_enabled', 'TRUE', 'TRUE', '信号窗口入池补充', 'Scheduler 调度(兼容 key)', 133.2, '09:20 主池后，在 09:30-10:30 ET 每 10 分钟执行增量扩池；只增加新可操作标的并按需提醒。Cron: 30,40,50 9 * * 1-5 与 0,10,20,30 10 * * 1-5；时区: America/New_York。受 Scheduler 总开关、本开关和 status_notify_enabled 共同控制。'),
