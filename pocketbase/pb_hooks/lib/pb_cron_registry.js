const PB_CRON_DEFINITIONS = [
    ...
    },
    {
        ...
        display_name: "Compute / 心跳 / 状态提醒 Cron",
        config_display_name: "Compute + 心跳状态提醒",
        group_name: "PB Cron 调度",
        sort_order: 132,
        default_value: "TRUE",
        ...
        window_label: "整点附带 ok 心跳，:00 / :30 附带状态提醒",
        function_summary: "触发 compute 调度，并串行执行健康检查通知与状态提醒。",
        scope_label: "按环境执行",
        note: "通知是否真正发送，还受 health_check_notify_enabled / status_notify_enabled 控制。",
