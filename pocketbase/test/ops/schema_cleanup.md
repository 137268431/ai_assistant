...
```bash
python3 pocketbase/scripts/schema/collection_usage_audit.py
```
...
```bash
python3 pocketbase/scripts/schema/collection_usage_audit.py reverse_signals
python3 pocketbase/scripts/schema/collection_usage_audit.py order_details
```
